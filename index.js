function Student(name, roll_no, class_, section, marks) {
    ...
    this.printReportCard = function () {
        ...
        for (let subject in this.marks) {
            ...
            subjects.push(this.marks[subject]);
        }

        let totalMarks = subjects.reduce((acc, curr) => acc + curr, 0);
        let percentage = Math.round((totalMarks / (Object.keys(this.marks).length * 100)) * 100 * 10) / 10;
